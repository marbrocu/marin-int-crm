...
import ConfirmationDataTableModule from '@/modules/ConfirmationModule/ConfirmationDataTableModule/expiredIndex';


export default function ConfirmationExpired() {
